...
parenthesis */
    ...
    public String toString() {
        ...
        if (isValue()) {
            ...
            return String.format("(%s %c %s)", left.toString(), getOp(), 
right.toString());
        }
    }
...
parenthesis */
    ...
    public String toStringPostfix() {
        ...
        if (isValue()) {
            ...
            return String.format("%s %s %c", left.toStringPostfix(), 
right.toStringPostfix(), getOp());
        }
    }

    /* return the expression as a prefix notation string without 
parenthesis */
    /* The sample tree would be: "+ 3 * 2 10" */
    ...
    public String toStringPrefix() {
        ...
        if (isValue()) {
            ...
            return String.format("%c %s %s", getOp(), 
left.toStringPostfix(), right.toStringPostfix());
        }
    }
...
//////////////////// ONLY EDIT ABOVE THIS LINE////////////////////
    ...
    /*
     * TreeNodes are immutable, so no issues with linking them across 
multiple
...
*/
    ...
    public static void main(String[] args) {
        ...
        ExpressionTree d = new ExpressionTree('*', c, new 
ExpressionTree(3.5));
        ...
        ExpressionTree ex = new ExpressionTree('-', d, new 
ExpressionTree(1.0));
